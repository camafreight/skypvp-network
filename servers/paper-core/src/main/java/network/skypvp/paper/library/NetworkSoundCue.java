...
public enum NetworkSoundCue {
   ...
   MATCHMAKING_SEARCH(Sound.BLOCK_NOTE_BLOCK_HAT, 0.7F, 1.35F),
   MATCHMAKING_FOUND(Sound.ENTITY_EXPERIENCE_ORB_PICKUP, 0.85F, 1.2F),
   MATCHMAKING_FAIL(Sound.BLOCK_NOTE_BLOCK_BASS, 0.9F, 0.65F);
