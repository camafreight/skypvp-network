...
public final class InfuseHelmetDefinition implements CustomItemDefinition {

    public static final CustomItemTypeId TYPE_ID = new CustomItemTypeId("extraction", "infuse_helmet");
    ...
    public Optional<EquipmentSlotGroup> requiredEquipmentSlot() {
        return Optional.of(EquipmentSlotGroup.HEAD);
    }
}
