...
public class Settings extends YamlConfig {
  ...
  public Serializers SERIALIZER = Serializers.LEGACY_AMPERSAND;
    public String PREFIX = "SkyPvP &6>>&f";
  ...
  public static class MAIN {
    ...
    @Comment({
        "The SkyPvP limbo core will consume more RAM if this option is enabled, but compatibility with other plugins will be better",
    ...
    @Comment({
        ...
        "The SkyPvP limbo core will be running in compatibility mode, allowing other plugins to",
    ...
    @Comment({
        ...
        "Use your network's Velocity tooling to completely block Minecraft versions when needed.",
        "Available versions:",
    ...
    @Comment("Helpful if you want some plugins proceed before the SkyPvP limbo core. For example, it is needed to Floodgate to replace UUID.")
