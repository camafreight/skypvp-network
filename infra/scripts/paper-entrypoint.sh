...
RESOURCE_PACK_URL="${SPVP_RESOURCE_PACK_URL:-}"
RESOURCE_PACK_SHA1="${SPVP_RESOURCE_PACK_SHA1:-}"
RESOURCE_PACK_PUBLIC_HOST="${SPVP_RESOURCE_PACK_PUBLIC_HOST:-${SPVP_ADVERTISED_HOST:-}}"
